...
import ru.gor.library.config.Constants;
import ru.gor.library.domain.PersistentToken;
import ru.gor.library.domain.User;
import ru.gor.library.repository.AuthorityRepository;
import ru.gor.library.repository.PersistentTokenRepository;
import ru.gor.library.repository.UserRepository;
import ru.gor.library.security.AuthoritiesConstants;
import ru.gor.library.service.UserService;
import ru.gor.library.service.dto.AdminUserDTO;
import ru.gor.library.service.dto.PasswordChangeDTO;
import ru.gor.library.web.rest.vm.KeyAndPasswordVM;
import ru.gor.library.web.rest.vm.ManagedUserVM;
