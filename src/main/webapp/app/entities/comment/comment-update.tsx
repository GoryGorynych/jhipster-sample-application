  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplicationApp.comment.home.createOrEditLabel" data-cy="CommentCreateUpdateHeading">
            <Translate contentKey="jhipsterSampleApplicationApp.comment.home.createOrEditLabel">Create or edit a Comment</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jhipsterSampleApplicationApp.comment.comment')}
                id="comment-comment"
                name="comment"
                data-cy="comment"
                type="text"
              ...
              <ValidatedField
                ...
                name="book"
                data-cy="book"
                label={translate('jhipsterSampleApplicationApp.comment.book')}
                type="select"
              >
                <option value="" key="0" />
                {books
