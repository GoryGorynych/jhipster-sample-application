            ...
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th>
                    <Translate contentKey="jhipsterSampleApplicationApp.book.author1">Author 1</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="jhipsterSampleApplicationApp.book.genre">Genre</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {bookList.map((book, i) => (
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td>{book.author1 ? <Link to={`/author/${book.author1.id}`}>{book.author1.secondName}</Link> : ''}</td>
                    <td>{book.genre ? <Link to={`/genre/${book.genre.id}`}>{book.genre.genreName}</Link> : ''}</td>
