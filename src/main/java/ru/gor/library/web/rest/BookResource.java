...
/**
 * REST controller for managing {@link ru.gor.library.domain.Book}.
 */
@RestController
...
public class BookResource {
    ...
    public ResponseEntity<Book> partialUpdateBook(@PathVariable(value = "id", required = false) final String id, @RequestBody Book book)
        throws URISyntaxException {
