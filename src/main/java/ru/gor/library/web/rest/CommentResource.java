...
/**
 * REST controller for managing {@link ru.gor.library.domain.Comment}.
 */
@RestController
...
public class CommentResource {
    ...
    public ResponseEntity<Comment> updateComment(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, comment.getId()))
            .body(result);
    }
